...
export function Footer() {
    ...
    return (
        <footer className="flex flex-col w-full">
            <div className="footeritems w-full px-6 flex flex-row items-start justify-between">
                <div className="p-4 max-w-[33%] flex flex-col gap-4">
                ...
                <div className="p-4 max-w-[33%] flex flex-col gap-4"></div>
                <div className="p-4 max-w-[33%] flex flex-col gap-4 justify-end items-end">
